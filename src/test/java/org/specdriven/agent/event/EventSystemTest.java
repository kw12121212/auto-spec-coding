...
class EventSystemTest {
    ...
    void eventTypeCoversAllValues() {
        ...
        assertNotNull(EventType.valueOf("LLM_CONFIG_CHANGE_REJECTED"));
        ...
        assertNotNull(EventType.valueOf("INTERACTIVE_COMMAND_HANDLED"));
        ...
        assertNotNull(EventType.valueOf("WORKFLOW_CHECKPOINT_SAVED"));
        assertNotNull(EventType.valueOf("WORKFLOW_RECOVERED"));
        assertNotNull(EventType.valueOf("WORKFLOW_STEP_RETRY_SCHEDULED"));
        assertNotNull(EventType.valueOf("WORKFLOW_STEP_STARTED"));
        assertNotNull(EventType.valueOf("WORKFLOW_STEP_COMPLETED"));
        assertNotNull(EventType.valueOf("WORKFLOW_STEP_FAILED"));
        assertNotNull(EventType.valueOf("WORKFLOW_PAUSED_FOR_INPUT"));
        assertNotNull(EventType.valueOf("WORKFLOW_RESUMED"));
        assertNotNull(EventType.valueOf("PLATFORM_HEALTH_CHECKED"));
        assertNotNull(EventType.valueOf("PLATFORM_METRICS_SNAPSHOT"));
        assertNotNull(EventType.valueOf("PROFILE_EXECUTION_RECORDED"));
    }
