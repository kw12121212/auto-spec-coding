...
- WHEN the file declares a supported environment-profile section with one or more named profiles
...
- GIVEN a project YAML configuration whose environment-profile section is invalid or cannot resolve a valid selected profile
