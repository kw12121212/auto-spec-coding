...
- [m11-service-sql.md](milestones/m11-service-sql.md) - M11 - Service SQL + Skill 嵌入 - proposed
- [m12-native-java-sdk.md](milestones/m12-native-java-sdk.md) - M12 - Native Java SDK 层 - proposed
- [m13-jsonrpc-interface.md](milestones/m13-jsonrpc-interface.md) - M13 - JSON-RPC 接口 - proposed
...
- [m19-llm-streaming-token.md](milestones/m19-llm-streaming-token.md) - M19 - LLM Streaming & Token Management - proposed
...
- [m5-llm-backend.md](milestones/m5-llm-backend.md) - M5 - LLM Provider Layer - proposed
